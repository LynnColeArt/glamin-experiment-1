...
- [ ] Generalize entity, relation, and action-context representations across
  ...
  - [ ] Replicate composition stability with a known-entity veto, contrastive
    intent margin, prior-frozen regression gate, and untouched positive and
    counterfactual splits; protocol frozen before implementation.
